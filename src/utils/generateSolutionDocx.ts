    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({ children: [new TextRun({ text: "1.2 Scope of Change", bold: true })] }),
          ...
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "1.3 Existing Functionality", bold: true })] }),
          new Paragraph({ text: form.existingFunctionalityStatus === "New" ? "This is a New Functionality." : form.existingFunctionalityDetails }),

          new Paragraph({ children: [new TextRun({ text: "1.4 Feasibility", bold: true })] }),
          ...
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "Sample Example:", bold: true })] }),
          ...
          // ERROR CODES
          new Paragraph({ children: [new TextRun({ text: "Error Code and Error Description in Detail:", bold: true })] }),
          new Table({
            width: { size: 100, type: WidthType.PERCENTAGE },
            rows: [
          ...
          new Paragraph({ children: [new TextRun({ text: "Error Code and Error Description in Detail for Gateway with response status - 2:", bold: true })] }),
          new Table({
            width: { size: 100, type: WidthType.PERCENTAGE },
            rows: [
              createRow([{ text: "Error Codes", bold: true }, { text: "Error Description", bold: true }, { text: "Meaning", bold: true }]),
