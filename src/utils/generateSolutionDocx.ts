...
// --- Helper Functions --
const createCell = (text: string, bold = false, colSpan = 1, italics = false, alignment: any = AlignmentType.LEFT) => {
...
const createRow = (cells: { text: string; bold?: boolean; colSpan?: number; italics?: boolean; alignment?: any }[]) => {
  return new TableRow({
