...
export default function SftpUpload() {
  ...
  return (
    <div className="w-full max-w-xl mx-auto space-y-4">
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Target directory</label>
        <input
          type="text"
          value={targetDir}
      ...
      <button
        onClick={uploadAll}
        disabled={!hasQueued}
        className="w-full rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white disabled:bg-gray-300 disabled:cursor-not-allowed hover:bg-blue-700 transition-colors"
      >
        Send to SFTP
      </button>
    </div>
